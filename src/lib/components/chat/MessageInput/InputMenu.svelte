...
>
	<div
		...
		<span style="display: flex;border-radius: 50%;width: 25px;height:25px;background: #1890ff;color:#fff;
    align-items: center;
    justify-content: center;">file</span>
		上传文件
	</div>
	...
	<div slot="content">
		...
		>
			&lt;!&ndash;{#if Object.keys(tools).length > 0}
			...
			&lt;!&ndash;{#if $config?.features?.enable_google_drive_integration}
				<DropdownMenu.Item
